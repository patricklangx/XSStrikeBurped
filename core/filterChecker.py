...
def filterChecker(url, params, headers, GET, request_type, delay, occurences, timeout, encoding):
    ...
    for environment in environments:
        if environment:
            efficiencies = checker(url, params, headers, GET, request_type, delay, environment, positions, timeout, encoding)
